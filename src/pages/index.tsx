  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Construction Tool Rental - Empowering Individual Customers to Rent Construction Tools from a Central Supplier with Multiple Outlets, Effortlessly"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Construction Tool Rental - Empowering Individual Customers to Rent Construction Tools from a Central Supplier with Multiple Outlets, Effortlessly`}
            </Text>
            <Box
